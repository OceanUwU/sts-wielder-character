...
public class GuardUpPower extends AbstractWielderPower {
    public static String POWER_ID = makeID("GuardUp");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public GuardUpPower(AbstractCreature owner, int amount) {
