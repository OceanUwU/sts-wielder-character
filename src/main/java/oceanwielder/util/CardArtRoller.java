...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(WielderMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(WielderMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(WielderMod.makeImagePath("masks/PowerMask.png"));
    ...
    public static void computeCard(AbstractWielderCard c) {
