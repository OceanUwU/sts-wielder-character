...
public class SavingsAccount extends AbstractWielderCard {
    ...
    public static class NewDrawPower extends AbstractPower {
        public static final String POWER_ID = makeID("Draw");
        private static final PowerStrings powerStrings;
        public static final String NAME;
        public static final String[] DESCRIPTIONS;

        public NewDrawPower(AbstractCreature owner, int amount) {
            this.name = NAME;
            this.ID = POWER_ID;
            this.owner = owner;
            this.amount = amount;
        ...
        static {
            powerStrings = CardCrawlGame.languagePack.getPowerStrings(DrawPower.POWER_ID);
